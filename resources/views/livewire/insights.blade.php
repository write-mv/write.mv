<div>
            ...
            <section>
                <div class="flex justify-center gap-5">
                    <div class="inline-block align-bottom px-4 pt-5 pb-4 text-left">
                        <div>
                            <h3 class="text-lg leading-6 font-medium text-gray-900 text-center dark:text-gray-200 poppins">
                                Lifetime Summary
                            </h3>
                            <dl
                                class="mt-5 grid grid-cols-1 rounded-lg bg-white dark:bg-gray-900 overflow-hidden divide-y divide-gray-200 md:grid-cols-2 md:divide-y-0 md:divide-x">
    ...
    <section>
        <h3 class="text-gray-700 text-xl font-semibold mb-3 text-center poppins dark:text-gray-200">Top 10 Popular Posts 🔥</h3>
        <div class="flex flex-col py-3 w-auto overflow-y-auto overflow-hidden bg-gray-100 dark:bg-gray-800">
            <div class="flex flex-col items-center">
                @foreach ($top_10_posts as $post)
                <div class="pt-4 ml-2 mr-2 rounded-lg lg:w-2/3">
                    <a href="{{route('domain.posts.show', ['name' => $post->blog->name ,'post' => $post->slug])}}" class="block bg-white dark:bg-gray-900 rounded-lg py-3 pb-4">
                        <div class="px-4 py-2 flex justify-between">
                            <span class="text-md font-semibold text-gray-700 dark:text-gray-200 {{$post->is_english ? "poppins" : "para-dhivehi"}}">{{$post->title}}</span>
                            <div class="flex">
