    ...
    <form wire:submit.prevent="update">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="bg-white dark:bg-gray-900 py-6 px-4 space-y-6 sm:p-6">
                <div>
                    <h2 id="password_settings_heading" class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-200">Password
                        Settings</h2>
                    <p class="mt-1 text-sm leading-5 text-gray-500 dark:text-gray-400">Update the password used for logging into your
                        account.</p>
                </div>
                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12">
                        <label for="current_password" class="block text-sm font-medium leading-5 text-gray-700 dark:text-gray-200">
                            Current password
                        </label>
                        <div>
                            <div class="relative">
                    ...
                    <div class="col-span-12">
                        <label for="password" class="block text-sm font-medium leading-5 text-gray-700 dark:text-gray-200 ">
                            New Password
                        </label>
                        <div>
                            <div class="relative">
                    ...
                    <div class="col-span-12">
                        <label for="password_confirmation" class="block text-sm font-medium leading-5 text-gray-700 dark:text-gray-200">
