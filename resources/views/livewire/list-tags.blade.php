                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @endif
                            <tbody class="dark:bg-gray-900 bg-white divide-y dark:divide-gray-100 divide-gray-200">
                                @forelse ($tags as $tag)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                            ...
                                            class=" cursor-pointer block px-4 py-2 text-sm text-gray-700
                                                        hover:bg-gray-100 hover:text-gray-900 poppins"
                                ...
                                @empty
                                    ...
                                    <div class="flex justify-start items-center">
                                        ...
                                        <span class="font-medium py-8 text-gray-400 text-xl poppins">No tags
                                            found.</span>
                                    </div>
