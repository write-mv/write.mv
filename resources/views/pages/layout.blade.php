        ...
        <nav class="relative max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6">
            ...
            <div class="hidden md:block text-right text-gray">
                <a class="text-scarlet-600 hover:text-scarlet-500 ml-4 font-medium transition duration-150 ease-in-out"
                    href="https://www.facebook.com/write.mv/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2500" height="2031"
                        viewBox="-0.25 -0.25 1109.5 901.5" class="h-6 w-6 inline" aria-hidden="true">
                        <path
                ...
                <a class="text-scarlet-600 hover:text-scarlet-500 ml-4 font-medium transition duration-150 ease-in-out"
                    href="https://twitter.com/write_mv">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1298" height="2500"
                        viewBox="88.428 12.828 107.543 207.085" class="h-6 w-6 inline" aria-hidden="true">
                        <path
            ...
            <div class="rounded-lg shadow-md">
                <div class="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical"
                    ...
                    <div class="bg-gray-50 text-center">
                        ...
                        <a class="text-scarlet-600 hover:text-scarlet-500 inline-block px-5 py-3 text-center font-medium bg-gray-50 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" href="https://www.instagram.com/write.mv/">
