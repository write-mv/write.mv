...
return [
     ...
     */
    'classes' => [
        'bubble' => 'hidden sm:block | bg-blue-600 rounded-full shadow-lg w-14 h-14 text-white p-4 border-none',
        'input' => 'bg-gray-100 border border-gray-200 w-full max-w-full p-2 rounded-sm shadow-input text-gray-800 text-base',
        'button' => 'inline-flex place-center px-4 py-3 h-10 border-0 bg-blue-600 hover:bg-blue-700 active:bg-blue-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
];
